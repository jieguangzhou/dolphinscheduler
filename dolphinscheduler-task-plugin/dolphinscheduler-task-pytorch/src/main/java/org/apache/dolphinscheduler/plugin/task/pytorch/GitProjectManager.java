...
public class GitProjectManager {
    ...
    public final String GIT_PATH_LOCAL = "GIT_PROJECT";
...
//        CloneCommand cloneCommand = Git.cloneRepository().setURI(getGitUrl());
//        cloneCommand.setDirectory(new File(GIT_PATH_LOCAL)).call();
